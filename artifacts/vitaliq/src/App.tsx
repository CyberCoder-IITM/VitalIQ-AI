...
function GlobalKeyboardHandler() {
  ...
  const { setActiveTab, toggleAlertsDrawer, toggleTriageDrawer, setKeyboardShortcutsOpen, keyboardShortcutsOpen } = useClinicalStore();
  ...
  }, [location, navigate, patients, setActiveTab, toggleAlertsDrawer, toggleTriageDrawer, setKeyboardShortcutsOpen, keyboardShortcutsOpen]);
...
function App() {
  const { keyboardShortcutsOpen } = useClinicalStore();
  return (
